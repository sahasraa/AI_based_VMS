...
import personal from "../../src/images/personal-information.png"
import visitor from './../images/visitors.png'
import verify from './../images/verify.png'
import form from "../../src/images/wmremove-transformed-removebg-preview.png"
...
if(current===0){
  ...
  const steps = [
    {
      ...
      content: (
       ...
       <div className="">
       <div  className={` ${submitted && errors.gender ? "":"mb-3"} flex  flex-row items-center gap-3 `}>
      ...
      <label>
       ...
       {submitted && errors.gender && (
            <div className="text-red-500 mb-3">{errors.gender}</div>
          )}
       </div>
  ...
  const next = () => {
    ...
    if (
      ...
      (current === 1 
        && formData.category && formData.meet_employee && formData.purpose &&
        valid) ||
      (current === 2 && formData.images && formData.signature)
    ) {
...
<div><img   height={400} width={400}   className=""       src={form} alt=""/></div>
