...
import notfound from "./../images/visitor.png"
    ...
    if (value === "") {
      ...
      if (value !== "") {
       const filtered = employees.filter((person) =>
          person.name.toLowerCase().includes(value.toLowerCase()) || person.unique_id.toLowerCase().includes(value.toLowerCase()) 
        );
     ...
     // Update employees with search results
    }
  };
      ...
      <div className="lg:px-24 md:px-2 sm:px-2 w-full mt-28">
        ...
        {!filteredemployees.length > 0 &&  !loading &&(
          <div className="  flex flex-col items-center justify-center w-full h-64   rounded-lg p-6">
            <img className=" h-full" src={notfound} alt="not found"></img>
